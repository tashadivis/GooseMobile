...
<td><input type="text" name="cart_cancel_from_paypal_url" value="'.$cancel_url.'" size="100" /><br />'.(__("The customer will be sent to the above page if the cancel link is clicked on the PayPal checkout page.", "wordpress-simple-paypal-shopping-cart")).'</td>
</tr>
