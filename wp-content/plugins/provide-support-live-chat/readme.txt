...
= 2.1.1 =
* Compatibility issues fixed. Note! The plugin requires PHP 5.3.1 or higher and WordPress 3.9 or higher now. Please don't upgrade if you are not sure.
Use [live chat plugin version 2.0.3](https://downloads.wordpress.org/plugin/provide-support-live-chat.2.0.3.zip "Live Chat plugin") if your PHP/WordPress doesn't meet the new version requirements.
